...
import "./App.css";
import profile from "./images/profile.jpg"; // Make sure to place a profile image in the src folder
        ...
        <div className="overlay">
          <div className="content" id="home">
            ...
            <p>
              ...
              high-quality work, and encourages me to flourish as a software
              developer.
            </p>
          </div>
        </div>
        ...
        <div className="resume-content">
          <div className="education">
            ...
            <div className="resume-item">
              ...
              <p>
                Learned advanced topics in Cybersecurity for control systems.
              </p>
            </div>
            <div className="resume-item">
              ...
              <p>
                Focused on software development, web technologies, and mobile
                app development.
              </p>
            </div>
          </div>
          <div className="work-experience">
            ...
            <div className="resume-item">
              ...
              <p>Self-employed</p>
              <p>
                Built several web and mobile applications for various clients
